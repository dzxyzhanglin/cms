<?php /*a:2:{s:57:"C:\PHP\WWW\YZNCMS\application\admin\view\config\edit.html";i:1554268222;s:58:"C:\PHP\WWW\YZNCMS\application\admin\view\index_layout.html";i:1554268222;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-card">
    ...
    <div class="layui-card-body">
        <form class="layui-form form-horizontal" action="<?php echo url('admin/config/edit',['id'=>$info['id']]); ?>" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline w300">
                    <input type="text" name="title" value="<?php echo htmlentities($info['title']); ?>" lay-verify="title" autocomplete="off" placeholder="字段中文标题" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline w300">
                    <input type="text" name="name" value="<?php echo htmlentities($info['name']); ?>" autocomplete="off" placeholder="字段英文名称" class="layui-input">
                </div>
...
....." class="layui-textarea"><?php echo htmlentities($info['options']); ?></textarea>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline w300">
                    <input type="number" name="listorder" lay-verify="title" autocomplete="off" placeholder="只能是正整数" class="layui-input" value="<?php echo htmlentities($info['listorder']); ?>">
                </div>
            </div>
            <div class="layui-form-item">
